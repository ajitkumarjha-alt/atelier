...
export default function CalculationComingSoon({ calculationType, icon: Icon = Calculator, calculationId }) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-lodha-steel/30 p-12">
      <div className="text-center">
        ...
        <h2 className="text-2xl font-semibold text-lodha-black mb-2">Coming Soon</h2>
        <p className="text-lodha-grey max-w-md mx-auto">
        ...
        <div className="mt-6 text-sm text-lodha-grey/70">
        ...
        <div className="mt-8 p-4 bg-blue-50 rounded-lg">
          <p className="text-sm text-lodha-grey">
            {canGenerate() ? (
              ...
              <span className="text-lodha-grey">
        ...
        {canGenerate() && calculationId && (
          <div className="mt-6 flex gap-3 justify-center">
            ...
            <button
              className="px-6 py-2 bg-lodha-grey text-white rounded-lg hover:bg-lodha-cool-grey transition flex items-center gap-2"
              disabled
            >
